...
public class Servlet1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		writer.append("<h1>1. This is example of creating servlet by extending HttpServlet</h1>");
		...
		writer.append("<br/><a href='2'>Click Here</a> to visit URL 'http://localhost:8080/JavaCoreServlet/2' ");
